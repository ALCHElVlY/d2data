...
(function () {
	app = new Vue({
		...
		data: {
			...
			fontSize: 1,
			d2: {
				MonLvl: fetch('https://raw.githubusercontent.com/ALCHElVlY/d2data/master/json/monlvl.json').then(response => response.json()),
				monstats: fetch('https://raw.githubusercontent.com/ALCHElVlY/d2data/master/json/monstats.json').then(response => response.json()),
				Levels: fetch('https://raw.githubusercontent.com/ALCHElVlY/d2data/master/json/levels.json').then(response => response.json()),
			},
